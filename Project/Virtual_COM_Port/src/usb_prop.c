...
void CustomHID_Reset(void)
{
  ...
  OTG_DEV_EP_Init(EP1_IN, OTG_DEV_EP_TYPE_INT, HID_IN_SIZ);
  
  /* Init EP1 OUT as Interrupt endpoint */
  OTG_DEV_EP_Init(EP1_OUT, OTG_DEV_EP_TYPE_INT, HID_OUT_SIZ);
#else 
  ...
  SetEPTxCount(ENDP1, HID_IN_SIZ);
  SetEPRxCount(ENDP1, HID_OUT_SIZ);
